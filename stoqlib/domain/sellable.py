...
from stoqlib.database.properties import DateTimeCol, UnicodeCol, IntCol, UUIDCol
...
class SellableCategory(Domain):
    ...
    tax_constant_id = UUIDCol(default=None)
...
class Sellable(Domain):
    ...
    default_sale_cfop_id = UUIDCol(default=None)
