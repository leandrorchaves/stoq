...
class SaleItem(Domain):
    ...
    *self* was sold, it's taxes, the quantity, etc.
    ...
    delivery_id = UUIDCol(default=None)

    #: |delivery| or None
    delivery = Reference(delivery_id, 'Delivery.id')

    cfop_id = UUIDCol(default=None)
